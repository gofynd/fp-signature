        ...
        request = {
            ...
            headers: {
                ...
                "x-user-data": JSON.stringify({
                    ...
                    "_id": "bf304748658ccfd800085839",
                    "username": "ajaysaini_gofynd_com_22303",
                    "emails": [
                      {
                        "email": "ajaysaini@gofynd.com",
                        "active": true,
                        "primary": true,
                        "verified": true
                      },
                      {
                        "email": "ajaysaini@fynd.com",
                        "active": true,
                        "primary": false,
                        "verified": true
                      }
                    ...
                    "active": true,
                    "status": "active",
                    "password_last_modified": "2024-03-01T11:34:06.121Z",
                    "password_history": [],
                    "uid": "14639",
                    "first_name": "Ajay",
                    "last_name": "saini",
                    ...
                    "account_type": "user",
                    "created_at": "2024-03-01T11:34:06.121Z",
                    "updated_at": "2025-04-08T12:55:34.375Z"
                })
             },
        };

        const result = sign(request, { headers: ["x-user-data"] });

        expect(result["x-fp-signature"]).toEqual(
            "v1.1:3fd7274b29bcb3db56b234b586b4c377eaddfa74dbd99439be0995286b9ee606"
        );
        expect(result["x-fp-date"]).toEqual("20231026T053900Z");
    });
});
